...
$url = new moodle_url('/mod/assignment/type/simpleupload/upload.php', array('contextid'=>$contextid,
...
$instance = new assignment_simpleupload($cm->id, $assignment, $cm, $course);
...
$filemanager_options = array('subdirs'=>1, 'maxbytes'=>$assignment->maxbytes, 'maxfiles'=>$assignment->var1, 'accepted_types'=>'*', 'return_types'=>FILE_INTERNAL);
    ...
    $mform = new mod_assignment_simpleupload_form(null, array('contextid'=>$contextid, 'userid'=>$formdata->userid, 'options'=>$filemanager_options));
